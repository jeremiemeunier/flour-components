...
import type { AutoCompleteProps, DataItems } from "./AutoCompleteTag.types";
                ...
                <div className="windmillui-autocomplete-list">
                  <AnimatePresence>
                    {filteredData.map((option, index) => {
                      ...
                      return (
                        <div
                          className="windmillui-autocomplete-list-item"
                          onClick={() => {
                        ...
                        >
                          <p
                            ...
                            key={uniqueKey}
                            className="as-ma0 as-pa0"
                          >
                            {optionLabel}
                          </p>
                          {option.details && (
                            <p className="as-ma0 as-pa0 text label">
                              {option.details}
                            </p>
                          )}
                        </div>
